...
public class MinimiKeko {
    ...
    /**
     * The Classes constructor. Creates the array, and assigns it its maximum size. 
    */
    public MinimiKeko(int koko) {
        keko = new Solmu[koko];
    }
/**
 * This metho adds a Solmu to the end of the array, and then moves it to its rightful
 * place, increasing the tail variables value by one.
 ...
 */
    ...
    /**
     * Combines the two smallest Solmu objects in the heap into one, and adds the
     * newly created Solmu to the heap.
     */
    public void take() {
    ...
    /**
     * A helping method to make sure the minimum heaps requirements are still met
     * after the taking out of a Solmu. Decreases the tail variables value.
     */
    public void heapify(){
